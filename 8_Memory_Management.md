...
- With runtime binding, programs work entirely with logical addresses.
...
### Dynamic Linking (DLL - Dynamic Link Libraries)
...
- Solutions:
  - **Compaction**: consolidate free memory (requires runtime relocation).
